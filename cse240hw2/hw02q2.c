...
#include <stdio.h>
#pragma warning(disable : 4996) // needed in VS. Works like
...
// Part 1:
// We want to pass the value of 10 to isPositive and expect the result of
//isPositive to be 10, why is the result 11? Correct the error (6 points)
void part1(int x) {
int result;
++x;
result = isPositive(x);
...
//below.
printf("Explanation: original happened because the macro evaluated ++x twice\n\n\n"); // (3 points)
}
// Part 2:
// We want to pass incremented values of x and y to the macro and function to
...
// (6 points)
printf("In GCC: the result of polyFunc = 55 and polyMacro = 47 \n\n");
// (6 points)
...
printf("Explanation: it may be because they are being read in a different way or order in each \n\n"); // (3 points)
}
// Do not edit main()
int main()
{
