...
Patient::Patient()
{
	//sets to the default stuff originally 
	name = "abc";
	age = 19;
	DOByear = 2000;
	ID = 0;
...
{
	//like printf but better - cout << "whatever string" << variable << end line (adds new line and flushes)
	cout << "Name: " << name << endl; //l not 1
	cout << "Age: " << age << endl;
